...
function clickedlayer(id,obj){
   if (obj.checked){
       ...
       if (map.getLayer(id+"_symbol") != undefined){
        map.setLayoutProperty(id+"_symbol", 'visibility', 'visible');
    }
   }else{
       ...
       if (map.getLayer(id+"_symbol") != undefined){
        map.setLayoutProperty(id+"_symbol", 'visibility', 'none');
    }
   }
}
...
//    fetch(drawingLayer)
shp("./layers/BART_CensusBlocks2020").then(function(data){  
    //  .then((res) => res.json())
    //  .then((data) => {
